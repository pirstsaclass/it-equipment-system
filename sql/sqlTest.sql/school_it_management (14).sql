...
INSERT INTO `building_floor_plans` (`id`, `school_name`, `building_name`, `academic_year`, `floor_plan_image`, `plan_description`, `created_at`, `updated_at`) VALUES
(2, 'โรงเรียนวารีเชียงใหม่', 'อาคาร3-ประถม', 2568, '2568_VCS_อาคาร3ประถม.jpg', '', '2025-10-31 14:21:32', '2025-10-31 14:21:32');
...
(4, '6501005', 'จักรกฤษณ์', 'สุริยา', 19, 'IT', '', '122', '2025-11-01 09:52:32', '2025-11-01 09:52:32');
...
INSERT INTO `equipment` (`id`, `equipment_code`, `equipment_name`, `category_id`, `subcategory_id`, `brand_name`, `model_name`, `serial_number`, `purchase_date`, `warranty_expiry_date`, `purchase_price`, `supplier_name`, `equipment_status`, `location_school`, `location_building`, `location_floor`, `location_room`, `responsible_person`, `notes`, `image_path`, `created_at`, `updated_at`) VALUES
(1, 'VCS-COM-001', 'เครื่องคอมพิวเตอร์', 1, 1, 'Dell', 'OptiPlex 7090', 'SN001234567', '2024-01-15', '2027-01-15', 25000.00, NULL, 'ใหม่', 'โรงเรียนวารีเชียงใหม่', 'ตึก1-อำนวยการ', 'ชั้น 1', 'ห้องธุรการ', 'คุณสมชาย', NULL, NULL, '2025-10-31 03:28:49', '2025-10-31 03:28:49'),
(2, 'VCS-COM-002', 'โน้ตบุ๊ค', 1, 2, 'HP', 'ProBook 450 G8', 'SN987654321', '2024-02-20', '2027-02-20', 22000.00, NULL, 'ใหม่', 'โรงเรียนวารีเชียงใหม่', 'ตึก7-มัธยม', 'ชั้น 2', '201', 'คุณสมหญิง', NULL, NULL, '2025-10-31 03:28:49', '2025-10-31 03:28:49'),
(3, 'VCS-PRJ-001', 'โปรเจคเตอร์', 3, 11, 'Epson', 'EB-2250U', 'SNPRJ123456', '2023-08-10', '2026-08-10', 35000.00, NULL, 'ใช้งานปกติ', 'โรงเรียนวารีเชียงใหม่', 'ตึก3-ประถม', 'ชั้น 2', 'ห้องประชุม', 'คุณวิชัย', NULL, NULL, '2025-10-31 03:28:49', '2025-10-31 03:28:49'),
(4, 'VKS-COM-001', 'เครื่องคอมพิวเตอร์', 1, 1, 'Lenovo', 'ThinkCentre M90', 'SNLEN789012', '2024-03-01', '2027-03-01', 24000.00, NULL, 'ใหม่', 'โรงเรียนอนุบาลวารีเชียงใหม่', 'ตึก1-อำนวยการ', 'ชั้น 1', 'ห้องธุรการ', 'คุณสมชาย', NULL, NULL, '2025-10-31 03:28:49', '2025-10-31 03:28:49'),
(5, '6501202', 'PC', 1, 1, 'Asus', '', '', '2025-10-31', '2025-11-01', 15000.00, 'JIB', 'ใหม่', 'โรงเรียนวารีเชียงใหม่', 'อาคาร1-อำนวยการ', 'ชั้น 1', 'การเงิน', 'มอส', '', '6501202_PC.jpeg', '2025-11-01 15:05:10', '2025-11-01 15:05:10');
...
CREATE TABLE `equipment_categories` (
  `id` int(11) NOT NULL COMMENT 'รหัสหมวดหมู่ (Primary Key)',
  `category_name` varchar(100) NOT NULL COMMENT 'ชื่อหมวดหมู่ครุภัณฑ์',
  `category_description` text DEFAULT NULL COMMENT 'รายละเอียดหมวดหมู่',
  `created_at` timestamp NOT NULL DEFAULT current_timestamp() COMMENT 'วันที่สร้างบันทึก',
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp() COMMENT 'วันที่แก้ไขล่าสุด'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `equipment_categories` (`id`, `category_name`, `category_description`, `created_at`, `updated_at`) VALUES
(1, 'คอมพิวเตอร์', 'อุปกรณ์คอมพิวเตอร์และอุปกรณ์ต่อพ่วง', '2025-10-31 03:28:00', '2025-10-31 03:28:00'),
(2, 'เครื่องใช้สำนักงาน', 'เครื่องใช้สำนักงานทั่วไป', '2025-10-31 03:28:00', '2025-10-31 03:28:00'),
(3, 'อุปกรณ์โสตทัศนูปกรณ์', 'อุปกรณ์โสตและทัศนูปกรณ์', '2025-10-31 03:28:00', '2025-10-31 03:28:00'),
(4, 'เครื่องมือวัด', 'เครื่องมือวัดและอุปกรณ์วิทยาศาสตร์', '2025-10-31 03:28:00', '2025-10-31 03:28:00'),
(5, 'เฟอร์นิเจอร์', 'โต๊ะ เก้าอี้ ตู้ และเฟอร์นิเจอร์อื่นๆ', '2025-10-31 03:28:00', '2025-10-31 03:28:00'),
(6, 'อุปกรณ์เครือข่าย', '', '2025-11-01 13:26:41', '2025-11-01 13:26:41');
...
--
-- Dumping data for table `equipment_classroom`
--

INSERT INTO `equipment_classroom` (`id`, `equipment_code`, `school_name`, `building_name`, `floor_level`, `room_number`, `room_name`, `equipment_quantity`, `installation_date`, `placement_notes`, `created_at`, `updated_at`) VALUES
(1, 'VCS-COM-001', 'โรงเรียนนานาชาติวารีเชียงใหม่', 'อาคาร 8', 'ชั้น 1', '8210', 'ร', 1, '2025-10-31', '', '2025-11-01 09:33:39', '2025-11-01 09:33:39');
...
INSERT INTO `equipment_subcategories` (`id`, `category_id`, `subcategory_name`, `subcategory_description`, `created_at`, `updated_at`) VALUES
...
(19, 6, 'เราเตอร์ (Router)', '', '2025-11-01 13:26:41', '2025-11-01 13:26:41'),
(20, 6, 'สวิตช์ (Switch)', '', '2025-11-01 13:26:41', '2025-11-01 13:26:41'),
(21, 6, 'แอคเซสพอยต์ (Access Point)', '', '2025-11-01 13:26:41', '2025-11-01 13:26:41'),
(22, 6, 'โมเด็ม (Modem)', '', '2025-11-01 13:26:41', '2025-11-01 13:26:41'),
(23, 6, 'สายแลน (LAN Cable)', '', '2025-11-01 13:26:41', '2025-11-01 13:26:41'),
(24, 6, 'ตู้แร็ก (Rack Cabinet)', '', '2025-11-01 13:26:41', '2025-11-01 13:26:41');
...
CREATE TABLE `equipment_transfers` (
  `id` int(11) NOT NULL COMMENT 'รหัสการโอนย้าย (Primary Key)',
  `equipment_id` int(11) NOT NULL COMMENT 'รหัสครุภัณฑ์ (Foreign Key)',
...
CREATE TABLE `maintenance_logs` (
  `id` int(11) NOT NULL COMMENT 'รหัสบันทึก (Primary Key)',
...
(1, 'R202410-0001', 1, '2024-10-01', 'คอมพิวเตอร์เปิดไม่ติด', 'คุณสมศรี', 'สมชาย ใจดี', 'กำลังดำเนินการ', 'เปลี่ยนแหล่งจ่ายไฟใหม่', 2500.00, '2024-10-03', 'โรงเรียนวารีเชียงใหม่', 'ตึก1-อำนวยการ', 'ชั้น 1', 'ห้องธุรการ', '2025-10-31 03:29:04', '2025-11-01 10:13:08'),
...
--
ALTER TABLE `building_floor_plans`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัสแผนผัง (Primary Key)', AUTO_INCREMENT=3;
...
--
ALTER TABLE `employees`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัสพนักงาน (Primary Key)', AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `equipment`
--
ALTER TABLE `equipment`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัสครุภัณฑ์ (Primary Key)', AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `equipment_categories`
--
ALTER TABLE `equipment_categories`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัสหมวดหมู่ (Primary Key)', AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `equipment_classroom`
--
ALTER TABLE `equipment_classroom`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัสการจัดวาง (Primary Key)', AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `equipment_disposals`
--
ALTER TABLE `equipment_disposals`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัสการจำหน่าย (Primary Key)';

--
-- AUTO_INCREMENT for table `equipment_subcategories`
--
ALTER TABLE `equipment_subcategories`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัสหมวดหมู่ย่อย (Primary Key)', AUTO_INCREMENT=25;

--
-- AUTO_INCREMENT for table `equipment_transfers`
--
ALTER TABLE `equipment_transfers`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัสการโอนย้าย (Primary Key)';

--
-- AUTO_INCREMENT for table `maintenance_logs`
--
ALTER TABLE `maintenance_logs`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัสบันทึก (Primary Key)';

--
-- AUTO_INCREMENT for table `maintenance_requests`
--
ALTER TABLE `maintenance_requests`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัสการซ่อม (Primary Key)', AUTO_INCREMENT=4;
...
--
ALTER TABLE `equipment`
  ADD CONSTRAINT `equipment_ibfk_3` FOREIGN KEY (`category_id`) REFERENCES `equipment_categories` (`id`) ON DELETE SET NULL,
  ADD CONSTRAINT `equipment_ibfk_4` FOREIGN KEY (`subcategory_id`) REFERENCES `equipment_subcategories` (`id`) ON DELETE SET NULL;

--
-- Constraints for table `equipment_classroom`
--
ALTER TABLE `equipment_classroom`
  ADD CONSTRAINT `equipment_classroom_ibfk_2` FOREIGN KEY (`equipment_code`) REFERENCES `equipment` (`equipment_code`) ON DELETE CASCADE;

--
-- Constraints for table `equipment_disposals`
--
ALTER TABLE `equipment_disposals`
  ADD CONSTRAINT `equipment_disposals_ibfk_2` FOREIGN KEY (`equipment_id`) REFERENCES `equipment` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `equipment_subcategories`
--
ALTER TABLE `equipment_subcategories`
  ADD CONSTRAINT `equipment_subcategories_ibfk_1` FOREIGN KEY (`category_id`) REFERENCES `equipment_categories` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `equipment_subcategories_ibfk_2` FOREIGN KEY (`category_id`) REFERENCES `equipment_categories` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `equipment_transfers`
--
ALTER TABLE `equipment_transfers`
  ADD CONSTRAINT `equipment_transfers_ibfk_2` FOREIGN KEY (`equipment_id`) REFERENCES `equipment` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `maintenance_logs`
--
ALTER TABLE `maintenance_logs`
  ADD CONSTRAINT `maintenance_logs_ibfk_2` FOREIGN KEY (`maintenance_id`) REFERENCES `maintenance_requests` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `maintenance_requests`
--
ALTER TABLE `maintenance_requests`
  ADD CONSTRAINT `maintenance_requests_ibfk_2` FOREIGN KEY (`equipment_id`) REFERENCES `equipment` (`id`) ON DELETE CASCADE;
COMMIT;
