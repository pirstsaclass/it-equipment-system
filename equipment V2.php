...
if (isset($_GET['action'])) {
    ...
    if ($action == 'delete' && $id) {
        ...
        if ($equipment && $equipment['image'] && file_exists($equipment['image'])) {
        ...
        <div class="card-body">
            ...
            <div class="col-md-2">
                        ...
                        <select class="form-control" name="per_page" onchange="this.form.submit()">
                            ...
                            <option value="15" <?php echo ($records_per_page == 15) ? 'selected' : ''; ?>>15 รายการ</option>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <small class="text-muted">รองรับไฟล์: JPG, PNG, GIF (สูงสุด 5MB)</small>
                            </div>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-4 text-center mb-3">
                        <img id="viewImage" src="" alt="Equipment Image" class="img-fluid rounded border" style="max-height: 300px;">
                        <div id="viewNoImage" class="border rounded p-5 bg-light" style="display: none;">
                            <i class="fas fa-image fa-3x text-muted"></i>
                            <p class="text-muted mt-2 mb-0">ไม่มีรูปภาพ</p>
                        </div>
                    </div>
...
function editEquipment(equipment) {
    ...
    if (equipment.image) {
        document.getElementById('imagePreview').src = equipment.image;
...
function viewEquipment(equipment) {
    ...
    if (equipment.image) {
        document.getElementById('viewImage').src = equipment.image;
